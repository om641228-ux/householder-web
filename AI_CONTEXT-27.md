...
| GET/POST | `/api/planned-payments` | **Плановые платежи (v41):** список / добавление (title, category, amount, day_of_month); удаление — DELETE `/api/planned-payments/:id` (мягкое, active=false) |

...
**2026-08-06 (текущая финальная версия, v28 — кнопка «Локально»: бесплатный OCR Unlimited-OCR на Mac пользователя)**

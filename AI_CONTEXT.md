...
**2026-08-03 (текущая финальная версия, v15 — все страницы плотных документов распознаются без потерь)**
...
- Frontend без функциональных изменений (только watchdog → 2026-08-02.14)
- Версия бэкенда: 2026-08-02.14 (watchdog обновлён синхронно)

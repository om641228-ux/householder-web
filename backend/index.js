...
// redeploy-trigger: v168 worten-site-fix 2026-09-08T20:53:01.777258
...
app.get('/api/health', (req, res) => res.json({ status: 'ok', build: 'v168-2026-09-09', features: ['planned-freq', 'docs', 'crm-contact-files', 'model-monitor', 'doc-links-graph', 'pwa'] }));

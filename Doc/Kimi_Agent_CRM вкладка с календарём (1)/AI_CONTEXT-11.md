...
crm_tasks(id bigserial PK, owner_id text, title text NOT NULL, description text,
  ...
  timeline jsonb DEFAULT '[]',      -- [{ts, actor, action, note}], action: created|edited|comment|done|confirmed|returned
